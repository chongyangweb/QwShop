<template>
	<div class="index_main">
		<div class="main_btn_left">
			...
			<div class="index_main_title">分类添加</div>
		</div>
...
<script>
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/columns/add',{name:this.name,pid:this.pid,is_type:this.$route.params.is_type,sort:this.sort}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，添加成功！',
		          type: 'success'
		        });
