	...
	export default {
	    ...
	    methods: {
		      	...
		      	if(this.goods_id == ''){
	      			...
	      			this.$get(_this.ROOT_URL + "Seller/goods_spec/goods_spec_del/"+this.$route.params.id).then(function(res){
	      				_this.$get(_this.ROOT_URL + "Seller/goods_attr/goods_attr_del/"+_this.$route.params.id).then(function(res){
		      				_this.$post(_this.ROOT_URL + 'Seller/goods_attr/add',{goods_id:goods_id,name:guige,val:canshu}).then(function(res){
					      		_this.$message({
						          message: '恭喜你，规格添加成功！',
						          type: 'success'
						        });
	      ...
	      nextfo:function(){
	      	...
	      	if(spec_id != ''){
	      		this.$post(this.ROOT_URL + 'Seller/goods_spec/edit',{goods_id:goods_id,price:price,num:num,spec_id:spec_id}).then(function(res){
		      		_this.$message({
			          message: '恭喜你，SKU修改成功！',
			          type: 'success'
			        });
	      		...
	      		this.$post(this.ROOT_URL + 'Seller/goods_spec/add',{goods_id:goods_id,name:sku,price:price,num:num}).then(function(res){
		      		_this.$message({
			          message: '恭喜你，SKU添加成功！',
			          type: 'success'
			        });
