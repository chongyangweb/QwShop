		...
		<div class="main_content">
			...
			<el-row :gutter="20">
				...
				<el-col :span="10">
					<el-upload
					  ...
					  :action="ROOT_URL + 'Seller/store/avatar?token=' + getToken()"
			...
			<el-row :gutter="20">
				...
				<el-col :span="10">
					<el-upload
					  class="upload-demo"
					  :action="ROOT_URL + 'Seller/store/shop_thumb?token=' + getToken()"
					  :file-list="fileList2"
...
<script>
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Seller/store/edit' ,{content:this.content,name:this.name,logo:this.imageUrl,face_img:this.imageUrls,lat:this.lat,lng:this.lng,province:this.province,city:this.city,region:this.region,address:this.address}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，修改成功！',
		          type: 'success'
		        });
