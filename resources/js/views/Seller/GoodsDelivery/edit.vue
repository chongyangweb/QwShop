	...
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	...
	      	this.$post(this.ROOT_URL + 'Seller/goods_delivery/edit/' + this.$route.params.id ,{name:this.name,content:this.content}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，修改成功！',
		          type: 'success'
		        });
	      ...
	      selectArea:function(k){
	      	...
	      	var _this = this;
	    	this.$get(_this.ROOT_URL + "Seller/goods_area/getArea",{id:0}).then(function(res){
	    		_this.areaList = res;
	    		_this.is_sort = k;
	    	});
	      },
