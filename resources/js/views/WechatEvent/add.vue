...
<script>
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/wechat_cat/add',{name:this.name,pid:this.pid,content:this.content,is_sort:this.sort,is_type:this.is_type}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，添加成功！',
		          type: 'success'
		        });
