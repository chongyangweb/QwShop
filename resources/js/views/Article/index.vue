<template>
	<div class="index_main">
		<div class="main_btn_left">
			<router-link class="admin_fff_btn" :to="{name:'article_add'}"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link>
		...
		<div class="unline"></div>
			...
			<el-table ref="multipleTable" :data="lists" tooltip-effect="dark" size="medium" style="width: 100%" @selection-change="changeFun">‘
				...
				<router-link :to="{name:'article_edit',params:{id:scope.row.id}}"><el-button plain icon="el-icon-edit" >编辑</el-button></router-link>
				</template>
				</el-table-column>
	...
	export default {
	    ...
	    methods: {
	      ...
	      del:function(){
	      	...
	      	this.$post(this.ROOT_URL + 'Admin/article/del',{id:this.ids}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，删除成功！',
		          type: 'success'
		        });
	      ...
	      search:function(){
	      	var _this = this;
	    	_this.$post(this.ROOT_URL + 'Admin/article/index',{limit:this.page.limit,page:this.page.page,title:this.title}).then(function(res){
	      ...
	      getList:function(){
	      	var _this = this;
	    	_this.$post(this.ROOT_URL + 'Admin/article/index',{limit:this.page.limit,page:this.page.page}).then(function(res){
	    		_this.lists = res.data;
	    		_this.page = res.page;
	    	});
	      }
