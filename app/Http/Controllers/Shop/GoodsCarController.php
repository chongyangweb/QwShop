...
class GoodsCarController extends BaseController
{
    public function getGoodsCar(Request $req,GoodsCar $goods_car){
        if(!isset($req->token)){
    ...
    // 用戶购物车列表
    public function getGoodsCarList(Request $req,GoodsCar $goods_car){
        $userInfo = JWTAuth::parseToken()->touser();
    ...
    // 加入购物车
    public function addGoodsCar(Request $req,GoodsCar $goods_car,GoodsSpec $goods_spec,Goods $goods){
    	if(empty($req->token)){
    		return ['code'=>'500','message'=>'无token'];
    	}
    ...
    // 购物车数量修改
    public function editGoodsCarNum(Request $req,GoodsCar $goods_car,GoodsSpec $goods_spec,Goods $goods){
        $num = $req->num;
        $id = $req->id;
    ...
    public function delGoodsCar(Request $req,GoodsCar $goods_car,GoodsSpec $goods_spec,Goods $goods){
        $id = $req->id;
    ...
    public function delGoodsCarOrder(Request $req,GoodsCar $goods_car){
        $id = $req->id;
